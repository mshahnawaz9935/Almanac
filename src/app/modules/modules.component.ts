      ...
      this.http.get('https://almanacstudentapp.azurewebsites.net/onenote/aboutme')
              .map((res: Response) => res.json()).subscribe((Serverdata) => {
                ...
                this.user = Serverdata;
                         ...
                         setTimeout(()=> {  
                 this.http.get('https://almanacstudentapp.azurewebsites.net/api/instances?id=modules')
  ...
  onclick(moduleid, modulename){
    ...
    this.router.navigate(['/search']);
      ...
      getInstances() {
           ...
           this.http.get('https://almanacstudentapp.azurewebsites.net/api/instances?id=modulesonerror')
              .map((res: Response) => res.json())
              .catch((error:any) => 
                        {
                            console.log('Error instances is ', error);
