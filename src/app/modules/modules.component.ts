      ...
      this.http.get('https://students.almanac-learning.com/onenote/aboutme')
              .map((res: Response) => res.json()).subscribe((Serverdata) => {
                ...
                this.user = Serverdata;
                         ...
                         setTimeout(()=> {  
                 this.http.get('https://students.almanac-learning.com/api/instances?id=modules')
  ...
  onclick(moduleid, modulename){
    ...
    this.router.navigate(['/search']);
      ...
      getInstances() {
           ...
           this.http.get('https://students.almanac-learning.com/api/instances?id=modulesonerror')
              .map((res: Response) => res.json())
              .catch((error:any) => 
                        {
                            console.log('Error instances is ', error);
