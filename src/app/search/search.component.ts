...
export class SearchComponent implements OnInit {
  ...
  constructor(private http:Http , private DataService: DataService,private router: Router, private route: ActivatedRoute) {
    ...
    console.log(this.DataService.moduleid);
     this.http.get('http://angular2ap-testing.azurewebsites.net/note/checklogin')               // Check Login
  ...
  ngOnInit() {
     if(this.DataService.moduleid != '')
        ...
        this.http.get('http://angular2ap-testing.azurewebsites.net/api/instances')
  ...
  onSubmit()
  {
    ...
    // this.http.get('http://angular2ap-testing.azurewebsites.net/api/search?id='+ this.model.search + '&differentiator='+ this.slider1+ '&type=' + this.slider2)     
      // this.http.get('http://angular2ap-testing.azurewebsites.net/api/search?id='+ this.model.search)
    ...
    note()
  {
       ...
       window.open('http://angular2ap-testing.azurewebsites.net/note','_self' );
  ...
  {
       console.log('Authenticated');
       window.open('http://angular2ap-testing.azurewebsites.net/onenote','_self' );
   
  }
   onenotelogout()
  {
       window.open('http://angular2ap-testing.azurewebsites.net/onenote/disconnect','_self' );
   
  }
     logout()
  {
       window.open('http://angular2ap-testing.azurewebsites.net/note/logout','_self' );
