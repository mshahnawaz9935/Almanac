...
export class SearchComponent implements OnInit {
  ...
  constructor(private http:Http , private DataService: DataService,private router: Router, private route: ActivatedRoute) {
    ...
    console.log(this.DataService.moduleid);
     this.http.get('http://angular2ap.azurewebsites.net/note/checklogin')               // Check Login
        ...
        this.http.get('http://angular2ap.azurewebsites.net/onenote/checklogin')
        .map((res: Response) => res.json()).subscribe((dataFromServer) => {      //Check if user is logged in
         ...
         // this.router.navigate(['/account']);
          ...
          this.http.get('http://angular2ap.azurewebsites.net/onenote/aboutme')
  ...
  ngOnInit() {
     if(this.DataService.moduleid != '')
        ...
        this.http.get('http://angular2ap.azurewebsites.net/api/instances')
  ...
  onSubmit()
  {
    ...
    // this.http.get('http://angular2ap.azurewebsites.net/api/search?id='+ this.model.search + '&differentiator='+ this.slider1+ '&type=' + this.slider2)     
      // this.http.get('http://angular2ap.azurewebsites.net/api/search?id='+ this.model.search)
  ...
  {
       console.log('Authenticated');
       window.open('http://angular2ap.azurewebsites.net/onenote','_self' );
   
  }
   onenotelogout()
  {
       window.open('http://angular2ap.azurewebsites.net/onenote/disconnect','_self' );
   
  }
     logout()
  {
       window.open('http://angular2ap.azurewebsites.net/note/logout','_self' );
